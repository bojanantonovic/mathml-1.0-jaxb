...
@XmlType(name = "domainofapplication.type", propOrder = {
    "mstyle",
    "merror",
    "maction",
    "mspace",
...
@XmlRootElement(name = "domainofapplication")
public class Domainofapplication {
    ...
    protected org.w3.mathml.List list;
    protected Set set;
     ...
     *     
     */
    public org.w3.mathml.List getList() {
        return list;
    }
     ...
     *     
     */
    public void setList(org.w3.mathml.List value) {
        this.list = value;
    }
